Feature: Formatprüfungen Antrag
  ...
  Scenario Outline: Formatprüfungen Antrag anlegen: <titel>
    ...
    | 1       | 01-01-1978          | 123   | 12   | Kombi                    | 01-01-2021  | *** Bitte auswählen *** | privat      | 01-11-2022              | nok       | Keine jährliche Fahrleistung angegeben | Fehlerfall keine Kilometer ausgewählt   |
